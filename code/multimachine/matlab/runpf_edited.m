function [Pm, gg, bb, vi, delta, success] = runpf_edited(casedata, mpopt, fname, solvedcase)
...
%       gg : admittance matrix real(Ybus)
%       bb : admittance matrix imag(Ybus)
%       delta : equilibrium voltage angles
%       omega : equilibrium voltage magnitudes
%       Pm : equilibrium bus power injections
...
% admittance matrices
gg = real(Ybus); bb = imag(Ybus);

% output voltage angles: (argument of V)
delta = atan(imag(V)./real(V));
